...
public class Hasher {
  ...
  public static final String[] byte2chars = {
  ...
  /**
   * Hash a string using SHA-1 (default, cryptographically secure)
   * This is the standard method used throughout the system for compatibility.
   */
  ...
  /**
   * Hash a string using MurmurHash3 (faster, non-cryptographic)
   * Use this for performance-critical paths where cryptographic security isn't needed.
   * Provides excellent distribution properties and is ~3-5x faster than SHA-1.
   * 
   * Used by: Cassandra, Elasticsearch, Redis, and other high-performance distributed systems
   */
  public static String hashFast(String x) {
    return Blake3.hashToString(x);
  }
