...
public interface FlameContext {
  ...
  // Parallel version of fromTable using producer-consumer pattern with bounded queue
  // and worker-grouped batching. Uses ParallelLambdaExecutor + BatchedKVSIO for
  // significantly faster processing of large tables.
