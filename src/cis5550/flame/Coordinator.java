...
class Coordinator extends cis5550.generic.Coordinator {
  ...
  private static final String version = "v1 Dec 6 2025";

  static int nextJobID = 1;
  public static KVSClient kvs;  
  public static FlameContextImpl context;
    ...
    post("/submit", (request,response) -> {
      ...
      List<String> workersList = getWorkersString();
      Thread threads[] = new Thread[workersList.size()];
      String results[] = new String[workersList.size()];
      for (int i=0; i<workersList.size(); i++) {
        final String url = "http://"+workersList.get(i)+"/useJAR";
        final int j = i;
      ...
      // is submitted from a machine other than the coordinator, the coordinator won't have a local copy of the JAR file. We'll use
      ...
      context = new FlameContextImpl(jarName);
      try {
